...
class TrtNetworkHelper():
    ...
    def addLayerNorm(self, x, gamma, beta, layer_name=None, precision=None):
        ...
        # weights bias
        # trt_layer = self.network.add_scale(normalized_inputs, mode=trt.ScaleMode.CHANNEL, scale=trt.Weights(gamma),
        #                                       shift=trt.Weights(beta))
        # trt_layer.name = '_rescale'
        # trt_layer_get = trt_layer.get_output(0)
        # 
        ...
        # print('addLayerNorm::x:trt_layer', trt_layer)
